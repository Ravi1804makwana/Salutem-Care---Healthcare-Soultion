...
$dataPoints = array();
$sql = "SELECT count(*) as numbers, time_date from medicine_history where medical_shop_id = '$id' group by time_date";
...
var chart = new CanvasJS.Chart("chartContainer", {
    ...
    theme: "light2",
    title:{
        text: "Medicines Selling History "
    },
    axisY: {
        title: "Number of medicines(per day)"
    },
    axisX: {
        title: "Date"
    },
...
<?php
    $sql="SELECT * from medicine_history where medical_shop_id = '$id'";
                                    ...
                                    <div class="overview-item overview-item--c2">
                                        <div class="overview__inner">
                                            <div class="overview-box clearfix">
                                                ...
                                                <div class="text">
                                                    <h2><?php echo $no;?></h2>
                                                    <span>Number of Sales Medicines</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
