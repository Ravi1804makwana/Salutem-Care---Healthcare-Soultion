                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="overview-wrap">
                                        <h1><b style="color: teal;">Process Medicines</b></h1>
                                    </div>
                                </div>
                            </div>
                            <div>
                                        ...
                                        <div class="col">
                                            <div class="card shadow mb-3">
                                                <div class="card-header py-3">
                                                    <h3 class="text-primary m-0 font-weight-bold">Medicines</h3>
                                                </div>
                                                <div class="card-body">
                                                    <form action="prescribedmedicines.php" method="post">
                                                        <?php
                                                        $sql = "SELECT d.doctor_name, ml.medicine_name, ml.quantity, ml.id FROM medicine_list AS ml JOIN doctor AS d ON ml.doctor_id=d.doctor_id WHERE patient_id= $patient_id";
                                                        ...
                                                        if($rs -> num_rows !=0)
                                                        {
                                                            ...
                                                            while ($row = mysqli_fetch_array($rs)) {
                                                               ...
                                                               echo "<td>";
                                                               echo "<input type = 'checkbox' name='id[]' value=".$row['id']."  class = 'form-control'>";
                                                               echo "</td>";
