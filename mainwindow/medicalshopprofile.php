...
<html lang="en">
    ...
    <head>
    	<title>Medical Shop Profile</title>
        <?php require 'css.php'; ?>
    </head>
                    ...
                    <div class="section__content section__content--p30">
                        <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="card shadow mb-3">
                                                ...
                                                <div class="card-body">
                                                    <form action="medicalshop_updates/personalinfoupdate.php" method="post">
                            ...
                            <div class="card shadow mb-3">
                                ...
                                <div class="card-body">
                                    <form action="medicalshop_updates/updatecontactinfo.php" method="post">
                                        <div class="row">
                                            <div class="form-group col-lg-6">
                                            ...
                                            <div class="form-group col-lg-12">
                                                <?php
                                                    $times=explode(" -- ", $time_schedule);
                                                ?>
                                                <div class="row">
                                                    <div class="form-group col-lg-6">
                                                        <strong>Starting Time</strong> : <input type="time" class="form-control" value="<?php echo $times[0]; ?>" name="starttime"/>
                                                   </div>
                                                    <div class="form-group col-lg-6">
                                                        <strong>Closing Time</strong> : <input class="form-control" type="time"  value="<?php echo $times[1]; ?>"  name="endtime"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group col-lg-12">
